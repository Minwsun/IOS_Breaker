...
> ScriptURL         https://raw.githubusercontent.com/Minwsun/IOS_Breaker/refs/heads/main/js/revenuecat.js


[rewrite_local]

# ～ RevenueCat@duyvinh09
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/[^/]+$) url script-response-body https://raw.githubusercontent.com/Minwsun/IOS_Breaker/refs/heads/main/js/revenuecat.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts|subscribers) url script-request-header https://raw.githubusercontent.com/Minwsun/IOS_Breaker/refs/heads/main/js/deleteHeader.js
...
const mapping = {
  ...
  '1Blocker': ['premium', 'com.khanov.BlockerX.premium.lifetime'],
  'BlockerX': ['premium', 'com.khanov.BlockerX.premium.lifetime'],
  'VSCO': ['membership'],
  'UTC': ['Entitlement.Pro'],
